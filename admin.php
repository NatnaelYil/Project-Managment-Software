    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <p>
                    <a href="cUser.php" class="btn btn-lg btn-primary" role="button">Create New User</a>
                </p>
                    <a href="aStatus1.php" class="btn btn-lg btn-primary" role="button">Activate or Deactivate Accounts</a>
                </p>
                    <a href="bulkImport.php" class="btn btn-lg btn-primary" role="button">Bulk Import Feature</a>
                </p>
