<?php 
  ...
  $projectSql = "SELECT userNotificationID, title, body FROM UserNotification WHERE userNotificationID = '$notificationID'";
	...
	$(document).ready(function() {
        ...
        for (var i = 0; i < notifications.length; i++){
           $('#notificationList').append(
			...
			"<p class='list-group-item-text'>" + notifications[i].body + "</p>");
