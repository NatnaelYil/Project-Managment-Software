                                      ...
                                      <div class="col-lg-5">
                                          <div class="panel panel-default">
                                              <div class="panel-heading">
                                                  <h3 class="panel-title"> Search the Directory</h3>
                                              </div>
                                              <div class="panel-body">
                                                  <div class="table-responsive">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Name</label>
                                                        <input class="form-control" id="nameSelect">
                                                    </div>

                                                    <div class="form-group">
                                                        <label>Job Title</label>
                                                        <select class="form-control" id="jobTitleSelect">
...
<script>
	...
	var nameVal = $("#nameSelect").val();
		...
		$.ajax({ url: 'searchUser.php',
         data: {name: nameVal, jobTitle: jobTitleVal},
         type: 'post',
         success: function(output) {
                      var result = JSON.parse(output);
					  $("#userTable").empty();
					  for(var i = 0; i < result.length; i++){
						  $("#userTable").append("<tr><td>" + result[i]['userName'] + "</td></tr>")
					  }
                  }
		});
	});
